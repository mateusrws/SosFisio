                        ...
                        <div className="group bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-rose-100 hover:border-rose-300">
                            <div className="relative">
                                <div className="aspect-video overflow-hidden rounded-t-3xl">
                                    <iframe 
                                        className="w-full h-full"
                                        src="https://www.youtube.com/embed/3w4_s6KuR0k?si=nsC6PQy_3MX_mrEw"
                                        title="Veja o que mudou nas manobras de desengasgo - Samu 192 Ceará"
                                        frameBorder="0"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                        referrerPolicy="strict-origin-when-cross-origin"
                                        allowFullScreen
                            ...
                            <div className="p-6">
                                <h3 className="text-xl font-bold text-gray-800 mb-2">
                                    Veja o que mudou nas manobras de desengasgo
                                </h3>
                                <p className="text-gray-600 text-sm mb-4">
